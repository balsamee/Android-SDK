...
public class IndividualImagesController extends BaseController {
     ...
     * @return The singleton instance of the IndividualImagesController class 
     */
    public static IndividualImagesController getInstance() {
        if (null == instance) {
     ...
     */
    public void createApiV5IndividualImagesPostAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/individual_images");
                ...
                _parameters.put("individual_image[image]", individualImageImage);
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5IndividualImages2GetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/individual_images/2");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5IndividualImagesGetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
