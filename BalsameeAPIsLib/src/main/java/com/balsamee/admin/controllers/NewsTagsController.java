...
public class NewsTagsController extends BaseController {
     ...
     * @return The singleton instance of the NewsTagsController class 
     */
    public static NewsTagsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5NewsTagsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/news_tags");
