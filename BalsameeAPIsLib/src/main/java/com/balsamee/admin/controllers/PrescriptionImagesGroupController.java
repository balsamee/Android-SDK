...
public class PrescriptionImagesGroupController extends BaseController {
     ...
     * @return The singleton instance of the PrescriptionImagesGroupController class 
     */
    public static PrescriptionImagesGroupController getInstance() {
        if (null == instance) {
     ...
     */
    public void createApiV5ReservationRequests2668PrescriptionImagesGroupsPostAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/2668/prescription_images_groups");
                ...
                _parameters.put("prescription_images_group[prescription_images_attributes][][image]", prescriptionImagesGroupPrescriptionImagesAttributesImage);
