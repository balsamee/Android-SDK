...
public class PrescriptionGroupsController extends BaseController {
     ...
     * @return The singleton instance of the PrescriptionGroupsController class 
     */
    public static PrescriptionGroupsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5PrescriptionGroupsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/prescription_groups");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5ReservationRequests4271PrescriptionGroupsGetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/4271/prescription_groups");
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            ListPrescriptionsgroupsundercertainclinicvisit _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<ListPrescriptionsgroupsundercertainclinicvisit>(){});
