...
public class AdvertisementsController extends BaseController {
     ...
     * @return The singleton instance of the AdvertisementsController class 
     */
    public static AdvertisementsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5AdvertisementsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/advertisements");

                ///process query parameters
                Map<String, Object> _queryParameters = new HashMap<String, Object>();
                _queryParameters.put("advertisement_page", advertisementPage);
