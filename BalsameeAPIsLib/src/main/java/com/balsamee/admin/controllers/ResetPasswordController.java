...
public class ResetPasswordController extends BaseController {
     ...
     * @return The singleton instance of the ResetPasswordController class 
     */
     ...
     */
    public void createApiV5ResetPasswordsSendResetPasswordPostAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/reset_passwords/send_reset_password");
                ...
                _parameters.put("receiver", receiver);
     ...
     * @return    Returns the void response from the API call 
     */
    public void createApiV5ResetPasswordsResetPasswordPostAsync(
                final String receiver,
                final String token,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reset_passwords/reset_password");
