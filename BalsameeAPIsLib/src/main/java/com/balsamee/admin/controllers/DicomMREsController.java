...
public class DicomMREsController extends BaseController {
     ...
     * @return The singleton instance of the DicomMREsController class 
     */
    public static DicomMREsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5Individuals20225MresDicomMresGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/individuals/20225/mres/dicom_mres");
