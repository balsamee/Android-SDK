...
public class DrugsController extends BaseController {
     ...
     * @return The singleton instance of the DrugsController class 
     */
    public static DrugsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5DrugsGetAsync(
                final int active,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/drugs");

                ///process query parameters
                Map<String, Object> _queryParameters = new HashMap<String, Object>();
                _queryParameters.put("active", active);
