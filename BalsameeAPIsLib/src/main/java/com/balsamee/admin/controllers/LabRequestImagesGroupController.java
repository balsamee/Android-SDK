...
public class LabRequestImagesGroupController extends BaseController {
     ...
     * @return The singleton instance of the LabRequestImagesGroupController class 
     */
    public static LabRequestImagesGroupController getInstance() {
        if (null == instance) {
     ...
     */
    public void createApiV5LabRequestImagesGroupsPostAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/lab_request_images_groups");
                ...
                _parameters.put("lab_request_images_group[lab_request_images_attributes][][image]", labRequestImagesGroupLabRequestImagesAttributesImage);
