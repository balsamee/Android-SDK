...
public class ListRadiologyRequestGroupsController extends BaseController {
     ...
     * @return The singleton instance of the ListRadiologyRequestGroupsController class 
     */
    public static ListRadiologyRequestGroupsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5RadiologyRequestGroupsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/radiology_request_groups");
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            Listradiologyrequestgroupfile _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<Listradiologyrequestgroupfile>(){});
