...
public class VideoExtensionController extends BaseController {
     ...
     * @return The singleton instance of the VideoExtensionController class 
     */
    public static VideoExtensionController getInstance() {
        if (null == instance) {
     ...
     */
    public void createApiV5VideoExtensionsPostAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/video_extensions");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5VideoExtensions76GetAsync(
                final String xAuthenticationToken,
                final String xSessionId,
                final String contentType,
                final APICallBack<Object> callBack
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/video_extensions/76");
