...
public class PrescriptionImagesController extends BaseController {
     ...
     * @return The singleton instance of the PrescriptionImagesController class 
     */
    public static PrescriptionImagesController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5PrescriptionImagesGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/prescription_images");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5PrescriptionImages58d23b9b5461720ee2000000GetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/prescription_images/58d23b9b5461720ee2000000");
     ...
     * @return    Returns the void response from the API call 
     */
    public void createApiV5ReservationRequests2668PrescriptionImagesPostAsync(
                final String xSessionId,
                final String xAuthenticationToken,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/2668/prescription_images");
                ...
                _parameters.put("prescription_image[image]", prescriptionImageImage);
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5ReservationRequests2668PrescriptionImagesGetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
