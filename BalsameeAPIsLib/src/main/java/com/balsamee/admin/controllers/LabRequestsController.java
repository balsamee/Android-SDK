...
public class LabRequestsController extends BaseController {
     ...
     * @return The singleton instance of the LabRequestsController class 
     */
    public static LabRequestsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5LabRequestsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/lab_requests");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5LabRequests515GetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/lab_requests/515");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5ReservationRequests2631LabRequestsGetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/2631/lab_requests");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5ReservationRequests2631LabRequests535GetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/2631/lab_requests/535");
