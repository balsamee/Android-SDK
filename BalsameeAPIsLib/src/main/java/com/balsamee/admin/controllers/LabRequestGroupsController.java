...
public class LabRequestGroupsController extends BaseController {
     ...
     * @return The singleton instance of the LabRequestGroupsController class 
     */
    public static LabRequestGroupsController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5LabRequestGroupsGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/lab_request_groups");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5ReservationRequests2631LabRequestGroupsGetAsync(
                final String xSessionId,
                final String xAuthenticationToken,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/reservation_requests/2631/lab_request_groups");
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            IndexlabrequestsgroupsforreservationrequestClinicvisit _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<IndexlabrequestsgroupsforreservationrequestClinicvisit>(){});
