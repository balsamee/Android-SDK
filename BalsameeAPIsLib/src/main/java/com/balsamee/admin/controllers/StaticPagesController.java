...
public class StaticPagesController extends BaseController {
     ...
     * @return The singleton instance of the StaticPagesController class 
     */
    public static StaticPagesController getInstance() {
        if (null == instance) {
     ...
     */
    public void getApiV5CallCenterNumberGetAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                StringBuilder _queryBuilder = new StringBuilder("/call_center_number");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5TermsAndConditionsGetAsync(
                final String lang,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/terms-and-conditions");
     ...
     * @return    Returns the void response from the API call 
     */
    public void getApiV5PrivacyPolicyGetAsync(
                final String lang,
                final APICallBack<Object> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //prepare query string for API call
                StringBuilder _queryBuilder = new StringBuilder("/privacy-policy");
